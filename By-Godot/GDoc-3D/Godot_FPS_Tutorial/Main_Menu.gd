...
func _ready():
	...
	$Level_Select_Menu/Button_Level_Testing_Area.connect("pressed", self, "level_select_menu_button_pressed", ["test_scene"])
...
func start_menu_button_pressed(button_name):
	if button_name == "start":
		...
		start_menu.visible = false
		$Options_Menu/Check_Button_Debug.pressed = get_node("/root/Globals").debug_display_on
		$Options_Menu/Check_Button_VSync.pressed = OS.vsync_enabled
...
func options_menu_button_pressed(button_name):
	...
	if button_name == "back":
		...
		globals.debug_display_on = !globals.debug_display_on
		get_node("/root/Globals").set_debug_display(globals.debug_display_on)
