...
var tile_size = 64 # tile size (in pixel)
var width = 35 # width of map (in tile)
var height = 20 # height of map (in tile)

var map_seed = 0

onready var Map = $TileMap

var erase_fraction = .2
...
func check_neighbors(cell, unvisited): # return an array of unvisited neighbors
	var list = []
...
func make_maze():
	...
	while unvisited:
		...
		if neighbors.size() > 0:
			...
			# insert indermediate(connector) cell
			if dir.x != 0:
