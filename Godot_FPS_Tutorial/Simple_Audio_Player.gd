...
var audio_pistol_shot = preload("res://assets/Audio/gun_revolver_pistol_shot_04.wav")
var audio_gun_cock = preload("res://assets/Audio/gun_semi_auto_rifle_cock_02.wav")
var audio_rifle_shot = preload("res://assets/Audio/gun_rifle_sniper_shot_01.wav")
